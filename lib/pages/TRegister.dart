       ...
       child: Form(
        ...
        key: _formKey,
             ...
             child: Column(children: <Widget>[
                ...
                child: Column(
                      children: <Widget>[
                        Title(color: Colors.white, child: Text("Teacher Register", style: TextStyle(fontStyle: FontStyle.italic, fontSize: 32.0,color: Colors.white, fontWeight: FontWeight.bold),)),
                         TextFormField(
