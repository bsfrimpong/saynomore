        ...
        child: Column(children: <Widget>[
          ...
          AppCard(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: <Widget>[
                    Title(color: Colors.white, child: Text("Teacher", style: TextStyle(fontStyle: FontStyle.italic, fontSize: 32.0,color: Colors.white, fontWeight: FontWeight.bold),)),
                     TextFormField(
         ...
         Navigator.push(
                ...
                FlatButton(
                  onPressed: (){
                     Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => TSecondRoute()));
                  },
